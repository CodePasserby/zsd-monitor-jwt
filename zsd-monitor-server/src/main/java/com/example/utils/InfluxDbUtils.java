...
public class InfluxDbUtils {
    ...
    String password;
    String token = System.getenv("-F4QFwth-rXzYffsn9_h_4DKtaw46CodSmEfXPJfYK0m0yU2ZSTfKGQPb8kw-SSURA4F-npOn736abt4ru6_Bg==");
    private final String BUCKET = "monitor"; //仓库名
    private final String ORG = "monitor";  // 组织名
